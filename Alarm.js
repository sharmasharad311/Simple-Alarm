...
var currentTime = setInterval(function(){
	...
	//convert 24 hours format to standard time
...
function addZero(time) {
		...
		return (time < 10) ? "0" + time : time;  // 01 to 09
	
}
//in given lines we are storing the options from 01 to 12 for hours
function hoursMenu(){
...
hoursMenu();
//in given lines we are storing the options from 01 to 59 for minutes
function minMenu(){
